...
var Rules_1 = __webpack_require__(6);
...
var Validator = function () {
    ...
    _createClass(Validator, [{
        ...
        key: "setAttributeNames",
        value: function setAttributeNames(attributeNames) {
        ...
        value: function register(name, fn, message) {
            invariant(!!name && typeof name === "string" && !!fn && typeof fn === "function" && (!!message ? typeof message === "string" : true), "Parameters to create rule are incorrect.");
...
var findIndex = __webpack_require__(4);
...
var objectPath = __webpack_require__(2);
var Validator_1 = __webpack_require__(0);
...
var Messages = function () {
    ...
    _createClass(Messages, [{
        ...
        value: function getMessage(field, error, lang) {
            ...
            }, template).replace(":attribute", Validator_1.Validator.attributeFormatter(objectPath.get(this.attributeNames, field, field)));
        }
    }]);
...
var flat_1 = __webpack_require__(10);
var objectPath = __webpack_require__(2);
var Validator_1 = __webpack_require__(0);
var Rule_1 = __webpack_require__(8);
var Errors_1 = __webpack_require__(1);
    ...
    _createClass(Rules, [{
        ...
        value: function validate(input) {
            ...
            Object.keys(this.rules).forEach(function (field) {
                ...
                var passes = true;
                if (_this.rules[field].sometimes && value === undefined) {
                    return;
                }
        ...
        value: function validateAsync(input, passes, fails) {
            ...
            Object.keys(this.rules).forEach(function (field) {
                var value = objectPath.get(input, field);
                if (_this2.rules[field].sometimes && value === undefined) {
                    return;
                }
                _this2.rules[field].validators.forEach(function (rule) {
                    ...
                    var handleError = function handleError(reason) {
                        ...
                        _this2.errors.add(field, { name: rule.name, numeric: numeric, params: Object.assign({}, errorParams, { reason: reason }) });
                    };
...
var Rule = function () {
    function Rule(name, fn, message, isAsync, timeout) {
